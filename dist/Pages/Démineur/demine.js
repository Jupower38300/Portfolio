...
class Cell extends _react.default.Component {
  getValue() {
    const {
      value
    } = this.props;
    ...
    if (value.neighbour > 0) {
      return /*#__PURE__*/_react.default.createElement("span", {
        className: `neighbour neighbour-${value.neighbour}`
      }, value.neighbour); // Return a span with a specific class for styling
    }
  ...
  render() {
    ...
    const className = `cell ${value.isRevealed ? "" : "hidden"} ${value.isMine && isGameOver ? "is-mine" : ""} ${value.isFlagged ? "is-flag" : ""}`;
...
Cell.propTypes = {
  value: _propTypes.default.shape({
    ...
    isMine: _propTypes.default.bool.isRequired,
    neighbour: _propTypes.default.number.isRequired,
    isRevealed: _propTypes.default.bool.isRequired,
    isEmpty: _propTypes.default.bool.isRequired,
    isFlagged: _propTypes.default.bool.isRequired
  }).isRequired,
  onClick: _propTypes.default.func.isRequired,
  cMenu: _propTypes.default.func.isRequired,
  isGameOver: _propTypes.default.bool.isRequired // New prop for game over status
};
class Board extends _react.default.Component {
  ...
  getNeighbours(data, height, width) {
    ...
    for (let i = 0; i < height; i++) {
      for (let j = 0; j < width; j++) {
        if (!data[i][j].isMine) {
          let mineCount = this.traverseBoard(i, j, data).filter(cell => cell.isMine).length;
  ...
  traverseBoard(x, y, data) {
    ...
    for (const [dx, dy] of directions) {
      const newX = x + dx;
      const newY = y + dy;
      if (newX >= 0 && newX < this.props.height && newY >= 0 && newY < this.props.width) {
  ...
  revealBoard() {
    const updatedData = this.state.boardData.map(row => row.map(cell => ({
      ...cell,
      isRevealed: true
    })));
    this.setState({
  ...
  renderBoard(data) {
    return data.map(datarow => /*#__PURE__*/_react.default.createElement("div", {
      key: datarow[0].x,
      className: "row"
    }, datarow.map(dataitem => /*#__PURE__*/_react.default.createElement(Cell, {
  ...
  render() {
    return /*#__PURE__*/_react.default.createElement("div", {
      ...
      className: "game-info"
    }, this.renderFace(), " ", /*#__PURE__*/_react.default.createElement("div", {
      className: "mine-info"
    }, /*#__PURE__*/_react.default.createElement("span", {
      className: "mine_img",
      role: "img",
      "aria-label": "bomb"
    }, "\uD83D\uDCA3"), " ", this.state.mineCount)), /*#__PURE__*/_react.default.createElement("div", {
      className: "game_board"
    }, this.renderBoard(this.state.boardData)));
  }
}
class Demine extends _react.default.Component {
  state = {
    height: 10,
    width: 10,
    mines: 25
...
var _default = exports.default = Demine; // Correction: export Demine instead of Game